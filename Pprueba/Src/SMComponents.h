...
namespace SceneMaker {
	...
	static SceneMaker::Component* factory(Type type)
	{
		SceneMaker::Component* ret = nullptr;
		switch (type)
		{
		default:break;

		case PLAYER_CONTROLLER:
			ret = new SceneMaker::PlayerController();
			break;
		case CAMERA_CONTROLLER:
			ret = new SceneMaker::CameraController();
			break;
		case CAMERA:
			ret = new SceneMaker::Camera();
			break;
		case WALKER:
			ret = new SceneMaker::Walker();
			break;
		case MESH_RENDERER:
			ret = new SceneMaker::MeshRenderer();
			break;
		case PLANE_RENDERER:
			ret = new SceneMaker::PlaneRenderer();
			break;
		}
		return ret;
	}
